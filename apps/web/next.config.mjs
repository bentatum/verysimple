    ...
    config.module.rules.push({
      ...
      use: [
        ...
        createLoader(function (source) {
          ...
          console.log('lang:', lang) // Debug: print the value of lang
        
          let isDiff = lang.startsWith('diff-')
          console.log('isDiff:', isDiff) // Debug: print the value of isDiff
        
          let prismLang = isDiff ? lang.substr(5) : lang
          console.log('prismLang:', prismLang) // Debug: print the value of prismLang
        
          let grammar = Prism.languages[isDiff ? 'diff' : prismLang]
          console.log('grammar:', grammar) // Debug: print the value of grammar
        
          let tokens = Prism.tokenize(source, grammar, lang)
          console.log('tokens:', tokens) // Debug: print the value of tokens
        
          if (lang === 'css') {
            fixSelectorEscapeTokens(tokens)
            console.log('tokens after fixSelectorEscapeTokens:', tokens) // Debug: print the value of tokens after fixSelectorEscapeTokens
          }
